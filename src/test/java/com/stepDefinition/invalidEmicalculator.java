...
import com.pages.InvalidEmiCalculatorPage;
...
public class invalidEmicalculator extends BaseSteps {

    private InvalidEmiCalculatorPage invalidemicalculatorpage;
    private ExtentTest extTest = Hooks.extTest;
    
    public invalidEmicalculator() {
     	invalidemicalculatorpage  = new InvalidEmiCalculatorPage(Hooks.driver, Hooks.extTest);
    }
