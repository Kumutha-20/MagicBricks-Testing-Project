...
import com.pages.EmiCalculatorPage;
...
public class emiCalculator extends BaseSteps {
    ...
    public void the_user_is_on_view_propert_details_page() {
        emiPage = new EmiCalculatorPage(driver, extTest);
    ...
    public void user_validates_the_eligible_emi_amount() {
