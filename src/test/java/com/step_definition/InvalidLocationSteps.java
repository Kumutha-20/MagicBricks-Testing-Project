...
import com.pages.InvalidSearchHome_Page;
...
public class InvalidLocationSteps extends BaseSteps {
    ...
    InvalidSearchHome_Page invalidsearchPage;
    ...
    public void I_am_on_the_magicbricks_home_page() {
     	invalidsearchPage = new InvalidSearchHome_Page(driver, extTest);
    ...
    public void I_enter_in_the_search_bar(String location) {
        ...
        boolean actResult = invalidsearchPage.enterLocation1(location);
    ...
    public void i_click_on_the_search_button() {
        ...
        boolean actResult = invalidsearchPage.clickSearch1();
   ...
   /* @Then("a message {string} should be displayed")
    ...
    public void user_should_remain_on_the_home_page() {
        BaseSteps.sleep();
        boolean actResult = invalidsearchPage.validateStayOnHome();
